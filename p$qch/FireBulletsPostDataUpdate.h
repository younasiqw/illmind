...
namespace TEFireBullet {
	typedef void(__thiscall* FireBullets_t)(SSDK::C_TEFireBullets*, DataUpdateType_t);

	extern FireBullets_t g_fnOriginalFireBullets;

	void __stdcall FireBullets_PostDataUpdate(SSDK::C_TEFireBullets* thisptr, DataUpdateType_t updateType);
